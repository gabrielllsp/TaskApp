...
import com.gabriel.taskapp.databinding.FragmentHomeBinding
import com.gabriel.taskapp.ui.adapter.ViewPagerAdapter
...
class HomeFragment : Fragment() {
    ...
    private fun initListeners() {
        binding.btnLogout.setOnClickListener {
            showBottomSheet(
                titleBottom = R.string.text_button_dialog_confirm_logout,
